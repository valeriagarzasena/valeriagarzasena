# About Me:
Computer Science Senior at UTSA | Aspiring Software & Database Engineer<br><br>I specialize in backend development and cloud infrastructure, with a focus on creating tools that solve real-world problems. <br>My current work on Lumen, a disaster relief tracker, involves building a real-time, serverless API using AWS Lambda and DynamoDB to connect survivors with essential resources.<br>I have a strong foundation in both relational and NoSQL databases, as well as experience deploying full-stack applications on AWS environments. <br>As a Peer Mentor at UTSA, I am also dedicated to fostering a collaborative tech community and helping fellow students navigate the software engineering landscape.<br><br>Graduating May 2026 and looking to contribute to innovative teams in Software Engineering or Database Management.<br>
